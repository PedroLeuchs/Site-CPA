...
const cardObjects = [
    {
        ...
        imgSrc: '../assets/dani.png',
        sobre: 'Daniele Wolfart, coordenadora e professora universitária. Sou Tecnóloga em Desenvolvimento de Sistemas e especialista em Engenharia de Software, MBA de Gerenciamento de Projetos, MBA em Gestão Empresarial com enfase em Liderança e mestre em Ciência da computação.',
        membroID: 'membro1',
    ...
    },
    {
        ...
        imgSrc: '../assets/membrosCPA/Renato IFPR.jpg',
        sobre: 'Experiência com Inovação, Educação, Ciência e Tecnologia. Coordenador do Centro de Referência IFPR-Biopark, parceira público-privada para Educação, Pesquisa, Desenvolvimento & Inovação e Empreendedorismo.',
        membroID: 'membro2',
    ...
    },
    {
        ...
        cargo: 'Representante dos Técnicos-Administrativos',
        imgSrc: '../assets/membrosCPA/Marlise.jpg',
        sobre: 'Mestra em Desenvolvimento Rural Sustentável, Especialista em Docência no Ensino Superior, Graduada em Ciências Biológicas-bacharelado. Procuradora Institucional, Coordenadora de Regulação e Acadêmica. Experiência no Magistério Superior em várias áreas, incluindo Agronomia, Ciências Biológicas, Enfermagem, Fonoaudiologia, Engenharia Elétrica, Engenharia de Controle e Automação e Nutrição. Avaliadora INEP.',
        membroID: 'membro7',
        contato: 'https://www.linkedin.com/in/marlise-santos-de-napoli-8067a076/?originalSubdomain=br',
    },
    {
    ...
    },
    {
        ...
        cargo: 'Representantes dos Discentes',
        imgSrc: '../assets/membrosCPA/Nicolas.jpg',
        sobre: 'Em 2017, quando completei 16 anos, tive minha primeira oportunidade de emprego, trabalhei para Gelateria Perdonato, lá desenvolvi habilidades de comunicação e foco no cliente. No mesmo período consegui um segundo emprego freelance em um restaurante, com o objetivo de melhorar meu atendimento e comunicabilidade. Em 2018, surgiu- me a oportunidade de trabalhar no setor administrativo de uma famosa empresa de engenharia da região, a ADM Engenharia, onde conheci a Rosane(Gerente da empresa), a sua forte cobrança sobre toda a equipe em Foco, Responsabilidade e Organização foram lições e competências que aprendi e levo até hoje. Após um ano, tive uma das minhas maiores experiências que foi a oportunidade de trabalhar no time comercial da Stone Co. (Uma das maiores Fintechs do Brasil). Durante esse período fui convocado para servir o período obrigatório no Exército Brasileiro, onde tive a oportunidade de aprender e evoluir diversas habilidades, neste ciclo fui designado para auxiliar nas atividades na seção de informática do Batalhão.Após fechar meu ciclo no Exército, decidi encerrar meu ciclo na Stone igualmente, e decidi começar a estudar e aprender programação.',
        membroID: 'membro9',
    ...
    },
    {
        ...
        cargo: 'Representantes dos Discentes',
        imgSrc: '../assets/membrosCPA/Tatiane.jpg',
        sobre: 'Possuo 7 anos de experiência em Laboratórios de Análises, tais como Amostragem, ensaios, leituras, análises, avaliação e emissão de resultados. Elaborar relatórios, registros de ocorrências e liberação de resultados, Calibração de equipamentos, entre outras atividades desenvolvidas na rotina diária de laboratórios.',
        membroID: 'membro10',
